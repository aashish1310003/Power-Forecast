...
const PollutionComponent = ({ latitude, longitude }) => {
  ...
  useEffect(() => {
    const fetchPollutionData = async () => {
      try {
        const pollutionUrl = `https://api.openweathermap.org/data/2.5/air_pollution?lat=11.3306483&lon=77.7276519&appid=e7704bc895b4a8d2dfd4a29d404285b6`;
  ...
  <div className="detail vis">
   <p style={{ marginLeft: 170 }}><strong>Visibility</strong></p>
   <FontAwesomeIcon size="2xl" icon={faEyeLowVision}  color="white" style={{ marginLeft: 120, marginTop:-10 }} />
  </div>
</div>
      ...
      <p  style={{marginLeft:180,marginTop:-45, fontSize:28}}><strong>{weatherData.vis}</strong></p>
      </div>
    </div>
  );
};
